...
export default {
  ...
  computed: {
    ...
    selectedText () {
      ...
      return selectNumber <= 0 ? this.$t('shelf.selectBook') : (selectNumber === 1 ? this.$t('shelf.haveSelectedBook').replace('$1', selectNumber) : this.$t('shelf.haveSelectedBooks').replace('$1', selectNumber))
    },
    popupCancelBtn () {
